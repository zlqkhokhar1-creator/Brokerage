      ...
      <div className="bg-gradient-to-br from-primary/10 via-primary/5 to-transparent p-6 m-4 rounded-2xl">
        ...
        <div className="bg-card/50 backdrop-blur-sm rounded-lg p-3">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>{userPreferences.riskTolerance} Risk</span>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{userPreferences.riskTolerance}</p>
                </div>
                <div>
                ...
                <div className="col-span-2">
                  ...
                  <p className="text-sm text-muted-foreground">{userPreferences.investmentGoal}</p>
                </div>
                <div className="col-span-2">
