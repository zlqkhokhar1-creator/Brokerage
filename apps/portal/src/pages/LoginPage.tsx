    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600 dark:text-gray-400">Sign in to continue to InvestPro</p>
        </div>
        <form className="space-y-6">
          <div>
            ...
            <div className="relative mt-1">
              ...
              <input
                type="email"
                className="block w-full py-2 pl-10 pr-3 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600 dark:text-white"
