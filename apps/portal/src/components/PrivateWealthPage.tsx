            ...
            >
                ...
                >
                  <div className="flex items-center">
                    <motion.div 
                      ...
                      animate={{ 
                        color: portfolioAnimation.trend === 'up' ? '#fbbf24' : '#ff6b6b',
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <span className="text-yellow-400">PKR 180M</span>
                </motion.div>
                <motion.div 
                  className="flex items-center justify-between"
                  initial={{ opacity: 0, x: -20 }}
                ...
                >
                  ...
                  <span className="text-yellow-400">Sharpe: 1.4</span>
                </motion.div>
              </div>
            ...
            {[
              ...
              return (
                <Card key={index} className="group hover:shadow-lg transition-all duration-300">
                  <CardHeader>
                    <div className="w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-600 group-hover:scale-110 transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {[
              ...
              <Card key={index} className={`group relative hover:shadow-lg transition-all duration-300 ${
                index === 1 ? 'ring-2 ring-blue-500 border-blue-500' : ''
              }`}>
                {index === 1 && (
                ...
                <CardHeader>
                  <div className="text-center mb-6">
                    <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mx-auto mb-4 ${
                      index === 0 ? 'bg-blue-100' : index === 1 ? 'bg-blue-100' : 'bg-purple-100'
                    }`}>
                      <Crown className={`w-8 h-8 ${
                        index === 0 ? 'text-blue-600' : index === 1 ? 'text-blue-600' : 'text-purple-600'
                      }`} />
                    </div>
                    <CardTitle className="text-2xl mb-2">{tier.tier}</CardTitle>
                    <div className="text-3xl font-bold text-gray-900 mb-2">{tier.minimum}</div>
                ...
                <CardContent>
                  ...
                  <div className="border-t pt-6">
                    <div className="text-center mb-6">
                      <div className="text-lg font-semibold text-gray-900">Management Fee</div>
                      <div className="text-2xl font-bold text-blue-600">{tier.fee}</div>
                    </div>
            ...
            {[
              ...
              <Card key={index} className="group hover:shadow-lg transition-all duration-300">
                ...
                <CardContent>
                  ...
                  <Button className="w-full mt-6 group-hover:bg-blue-600 group-hover:scale-105 transition-all duration-300">
                    Request Information
                  </Button>
                </CardContent>
              </Card>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                ...
                <div className="font-semibold text-gray-700 mb-2">{metric.metric}</div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-900 via-blue-800 to-purple-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
            <Button size="lg" className="text-lg px-8 bg-yellow-500 hover:bg-yellow-600 text-black">
              Schedule Private Consultation
              <ArrowRight className="w-5 h-5 ml-2" />
            </Button>
            <Button size="lg" variant="outline" className="text-lg px-8 border-white text-white hover:bg-white hover:text-blue-900">
              <Phone className="w-5 h-5 mr-2" />
