...
import { TrendingUp, ArrowLeft, Eye, EyeOff, Mail, Lock, User, Loader2, CheckCircle, Phone } from 'lucide-react';

interface ModernSignupProps {
  onSignup: (user: { id: string; email: string; name: string; phone: string }) => void;
      ...
      <nav className="bg-background/80 backdrop-blur-xl border-b border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <Button
              variant="ghost"
              onClick={() => currentStep === 1 ? onNavigate('landing') : setCurrentStep(1)}
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 font-semibold text-lg">InvestPro</span>
            </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground mt-2">
              Join millions of traders building their financial future with InvestPro
            </p>
          </div>
            ...
            <CardHeader className="space-y-1 pb-4">
              <div className="text-center">
                <Badge variant="secondary" className="bg-primary/10 text-primary border-primary/20">
                  {currentStep === 1 ? 'Account Information' : 'Secure Your Account'}
                </Badge>
              </div>
            </CardHeader>
