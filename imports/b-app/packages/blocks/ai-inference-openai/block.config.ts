...
import { 
  GenerateCompletionInputSchema, 
  GenerateCompletionOutputSchema,
  GenerateCompletionInput,
  GenerateCompletionOutput,
  AICompletionGeneratedEvent
} from './src/schemas';
...
export default defineBlock({
  ...
  commands: {
    GenerateCompletion: defineCommand<GenerateCompletionInput, GenerateCompletionOutput>({
      handler: async (input: GenerateCompletionInput, context: BlockContext): Promise<GenerateCompletionOutput> => {
        ...
        try {
          ...
          const result: GenerateCompletionOutput = {
            completionId,
          ...
          const event: AICompletionGeneratedEvent = {
            completionId,
            userId: input.userId,
            model: input.model,
            promptLength: input.prompt.length,
      ...
      inputSchema: GenerateCompletionInputSchema,
      outputSchema: GenerateCompletionOutputSchema,
      policies: {
        authLevel: 'user',
...
function generateMockCompletion(prompt: string, model: string): string {
