...
const AdminDashboard: React.FC = () => {
  ...
  const fetchSystemMetrics = useCallback(async () => {
    try {
      ...
      if (complianceResponse.ok) {
        ...
        setComplianceAlerts(complianceData.data.alerts || []);
      }
  ...
  const handleComplianceAction = useCallback(async (issueId: string, action: string) => {
    try {
                  ...
                  <div key={user.id} className="flex items-center justify-between p-4 border rounded-lg">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="text-right">
                        ...
                        <p className="font-semibold">{formatCurrency(user.accountValue)}</p>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {alert.status === 'OPEN' && (
                        <div className="flex space-x-2">
                          <Button size="sm" variant="outline" onClick={() => handleComplianceAction(alert.id, 'INVESTIGATING')}>
                            Investigate
                          </Button>
                          <Button size="sm" onClick={() => handleComplianceAction(alert.id, 'RESOLVED')}>
                            Resolve
                          </Button>
                        </div>
                      )}
                  ...
                  <div key={index} className="p-4 border rounded-lg">
                    ...
                    <div className="grid grid-cols-3 gap-4 mb-4">
                      <div>
                        ...
                        <p className="font-semibold">{formatCurrency(activity.totalVolume)}</p>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <p className="font-semibold">{formatCurrency(activity.averageSize)}</p>
                      </div>
                    </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">{formatCurrency(selectedUser.accountValue)}</p>
                </div>
                <div>
